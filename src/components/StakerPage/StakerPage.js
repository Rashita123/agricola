                ...
                <div>
                  <dl class="mt-5 grid grid-cols-3 rounded-lg bg-white overflow-hidden shadow divide-y divide-gray-200 md:grid-cols-3 md:divide-y-0 md:divide-x">
                    <div class="px-10 py-6">
                      <div class="text-2xl font-bold">Stake RUP</div>
                      <dt class="mt-4 text-base font-normal text-gray-900">
                        Staking RUP helps in ensuring quality loans are
                        approved, and stakers get to verify them to secure the
                        network.
                      </dt>
                    </div>
              ...
              <div class="mt-4">
                <div class="relative bg-white p-6 shadow rounded-lg mt-8">
                  <div class="flex flex-col">
                    <div class="flex flex-row items-center justify-between">
                      <div>
                        <div class="rounded-md p-4">
                          <img
                            class="h-8"
                            src="assets/logos/rupya.png"
                            alt=""
                          />
                        </div>
                      </div>
                      <div class="flex flex-col">
                        <p class="text-2xl font-semibold text-gray-900">RUP</p>
                        <p class="text-sm font-medium text-gray-500 text-ellipsis">
                          0x3e1fB19E002c83e39a7307B1e5eF9A216B605ce3
                        </p>
                      </div>
                      ...
                      <div
                        onClick={(enabled) => setEnabled((enabled) => !enabled)}
                      >
                        <svg
                    ...
                    {enabled && (
                      <div class="flex flex-row bg-gray-50 -ml-6 -mr-6 -mb-6 mt-6 justify-between p-6 rounded-lg">
                        <div class="flex flex-col w-1/2 p-2">
                          <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                              ...
                              <input
                                type="text"
                                class="h-14 focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 text-base border-gray-300 rounded-md"
                          ...
                          <button
                            type="button"
                            class="justify-center mt-4 inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                          >
                            Stake
                          </button>
                        </div>
