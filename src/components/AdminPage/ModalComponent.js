...
export const ModalComponent = ({
  ...
  const handleClose = () =>
    setModalInfo({ ...modalInfo, openModal: false, userId: null });

  const currentInfo = pendingRequests.filter(
    (req) => req.metamaskAccount === modalInfo.userId
  )[0];
      ...
      >
        <Box sx={style}>
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            ...
            <b>Aadhar Card:</b> {currentInfo.aadhaarNumber} <br />
